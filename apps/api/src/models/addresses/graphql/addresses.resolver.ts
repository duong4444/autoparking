...
export class AddressesResolver {
  ...
  @Mutation(() => Address)
  async updateAddress(
    @Args('updateAddressInput') args: UpdateAddressInput, // có garageId
    @GetUser() user: GetUserType,
  ) {
  ...
  garage(@Parent() address: Address) {
    return this.prisma.garage.findUnique({ where: { id: address.garageId } });
  }
}
