...
export const Directions = ({
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      console.log('newDistance từ api: ', newDistance);

      setCoordinates(coordinates);
      console.log('coordinates từ api: ', coordinates);
  ...
  // useMemo ghi nhớ kqua của các tính toán ptap,ko tính lại khi các dependencies ko đổi
