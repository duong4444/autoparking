...
export const Car: React.FC<CarProps> = ({
  ...
  return (
    <>  
    {/* tạo khối hộp boxGeometry bdien xe 
        position đặt vị trí của xe (truyền qua props || do Spawner quản lý)
        rotation : xoay xe 90độ quanh trục y để hướng về phía trc/sau tuỳ forward
    */}
      <Box
        position={position}
